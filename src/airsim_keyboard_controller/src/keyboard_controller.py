...
import roslib; roslib.load_manifest('airsim_keyboard_controller')
import rospy
...
class KeyMapping(object):
	PitchForward     = QtCore.Qt.Key.Key_Up
	PitchBackward    = QtCore.Qt.Key.Key_Down
	RollLeft         = QtCore.Qt.Key.Key_Left
	RollRight        = QtCore.Qt.Key.Key_Right
	YawLeft          = QtCore.Qt.Key.Key_A
	YawRight         = QtCore.Qt.Key.Key_D
	IncreaseAltitude = QtCore.Qt.Key.Key_W
	DecreaseAltitude = QtCore.Qt.Key.Key_S
