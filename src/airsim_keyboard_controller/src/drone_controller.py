...
class BasicDroneController(object):
	def __init__(self):
		...
		self.pubReset   = rospy.Publisher('/bebop/reset',Empty,queue_size=10)
		
		# Allow the controller to publish to the /cmd_vel topic and thus control the drone
		self.pubCommand = rospy.Publisher('/airsim_node/Drone0/vel_cmd_body_frame',VelCmd,queue_size=10)
